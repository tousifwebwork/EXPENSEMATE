...
const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* DROPDOWN */}
      {open && (
        <div className="absolute right-0 mt-2 w-80 rounded-2xl border border-slate-200 bg-white shadow-lg z-50">
          {/* HEADER */}
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
            <p className="font-bold text-[#102a43]">Notifications</p>
            {unreadCount > 0 && (
              <button
            ...
            {loading ? (
              ...
              notifications.slice(0, 10).map((n) => (
                <div
                  ...
                  className={`cursor-pointer border-b border-slate-50 px-4 py-3 hover:bg-slate-50 ${
                    !n.isRead ? "bg-[#159a8c]/5" : ""
                  }`}
                >
